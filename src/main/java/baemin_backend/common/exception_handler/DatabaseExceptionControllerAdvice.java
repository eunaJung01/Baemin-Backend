...
import static baemin_backend.common.response.status.BaseExceptionResponseStatus.BAD_SQL_GRAMMAR;
import static baemin_backend.common.response.status.BaseExceptionResponseStatus.DATABASE_ERROR;
